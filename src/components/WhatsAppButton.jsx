...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-5 z-40 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg shadow-black/25 hover:scale-110 active:scale-95 transition-transform duration-200"
